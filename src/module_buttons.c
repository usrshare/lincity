...
lcicon module_graphic[NUMOF_MODULES];
...
void
draw_module (int module, lcicon icon)
{
    int x, y, xx, yy;
    int row, col;
    ...
    Fgl_blit (DL_BG, icon, x + mbw->x, y + mbw->y, 16, 16);
